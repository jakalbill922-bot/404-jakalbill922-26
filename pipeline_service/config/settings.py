...
class Settings(BaseSettings):
    ...
    max_candidates: int = Field(default=4, env="MAX_CANDIDATES")
    ...
    candidate_ranges: list[tuple[int, int]] = Field(default=[
        (25000, 4),    # 0-15k voxels → 4 candidates
        (35000, 3),    # 15k-25k voxels → 3 candidates
    ...
    timeout_ranges: list[tuple[int, int]] = Field(default=[
        (25000, 25),   # 0-25k voxels → 28 seconds timeout
        (35000, 24),   # 0-25k voxels → 28 seconds timeout
        (50000, 23),   # 0-25k voxels → 28 seconds timeout
